/* MAFIVERA — phone gate and mobile runtime hints */
(()=>{
  ...
  function gate(){
    ...
    if(!block){
      ...
      block.innerHTML='<div class="mobile-block-card"><img src="./assets/mafivera-logo.webp" alt="MAFIVERA"><h1>MAFIVERA ist ein Handygame</h1><p>Dieses Spiel ist für Smartphones mit Touchscreen und GPS entwickelt. Öffne MAFIVERA auf deinem Handy, erlaube den Standortzugriff und leg los.</p></div>';
    ...
    if(!phone) block.style.display='flex';
